...
rows[i].addEventListener("click", function() {
  ...
  var yearlevel = this.cells[5].innerHTML;
  var vfullname = this.cells[6].innerHTML;
  var vaddress = this.cells[7].innerHTML;
  var vage = this.cells[8].innerHTML;
  var vgender = this.cells[9].innerHTML;
  var birthday = this.cells[10].innerHTML;
  var vuniversity = this.cells[11].innerHTML;
  var contactnumber = this.cells[12].innerHTML;
  var emailaddress = this.cells[13].innerHTML;
  var vstatus = this.cells[14].innerHTML;
  var emergencycontactname = this.cells[15].innerHTML;
  var emergencycontactnum = this.cells[16].innerHTML;
  var emergencycontactnumrel = this.cells[17].innerHTML;
